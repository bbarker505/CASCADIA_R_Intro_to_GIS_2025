...
knitr::include_graphics(here("images", "tidyterra.png"))
```
:::
:::::
...
-   `ggplot2` creates static maps, whereas `leaflet` creates interactive maps  
-   Used for maps in web pages, including Shiny web apps  

```{r, echo = FALSE, out.width = "800px",  fig.align="left", fig.cap="Source: https://rstudio.github.io/leaflet/articles/shiny.html"}
knitr::include_graphics(here("images", "images_shiny3.png"))
```
